...
func (r *BookingRepository) FindByUserID(userID uint, page, pageSize int) ([]models.Booking, int64, error) {
...
func (r *BookingRepository) FindByRoomID(roomID uint) ([]models.Booking, error) {
	var bookings []models.Booking
...
func (r *BookingRepository) UpdatePaymentStatus(id uint, paymentStatus string) error {
...
// 如果有冲突的预订，返回 false
func (r *BookingRepository) CheckRoomAvailability(roomID uint, checkIn, checkOut time.Time) (bool, error) {
	var count int64
